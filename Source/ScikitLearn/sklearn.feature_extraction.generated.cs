    ...
    public static partial class sklearn
    {
        public static class feature_extraction
        {
            public class DictVectorizer
            {
                ...
                public PyDict vocabulary_ => Helpers.ToCSharpNDarray(self.GetAttr("vocabulary_"));
                public PyObject feature_names_ => Helpers.ToCSharpNDarray(self.GetAttr("feature_names_"));
            ...
            public static class text
            {
                public class CountVectorizer
                {
                    ...
                    public PyDict vocabulary_ => Helpers.ToCSharpNDarray(self.GetAttr("vocabulary_"));
                    public bool fixed_vocabulary_ => Helpers.ToCSharpNDarray(self.GetAttr("fixed_vocabulary_"));
