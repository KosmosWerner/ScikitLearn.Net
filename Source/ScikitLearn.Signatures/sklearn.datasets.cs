...
public static partial class sklearn
{
    ...
    public static class datasets
    {
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_20newsgroups(
            string? data_home = null,
            string subset = "train",
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_20newsgroups_vectorized(
            string subset = "train",
            PyTuple? remove = null,
            string? data_home = null,
            bool download_if_missing = true,
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_california_housing(
            string? data_home = null,
            bool download_if_missing = true,
            bool return_X_y = false,
            bool as_frame = false,
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_covtype(
            string? data_home = null,
            bool download_if_missing = true,
        ...
        public static PyObject fetch_file(
            string? url = null,
            string? folder = null,
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_kddcup99(
            string? subset = null,
            string? data_home = null,
            bool shuffle = false,
            int? random_state = null,
        ...
        public static sklearn.utils.Bunch fetch_lfw_pairs(
            string subset = "train",
            string? data_home = null,
            bool funneled = true,
            float resize = 0.5f,
            bool color = false,
            (Slice, Slice)? slice_ = null,
            bool download_if_missing = true,
            int n_retries = 3,
            float delay = 1.0f) => default!;

        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_lfw_people(
            string? data_home = null,
            bool funneled = true,
            float? resize = 0.5f,
            int? min_faces_per_person = 0,
            bool color = false,
            (Slice, Slice)? slice_ = null,
            bool download_if_missing = true,
            bool return_X_y = false,
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_olivetti_faces(
            string? data_home = null,
            bool shuffle = false,
            int? random_state = 0,
            bool download_if_missing = true,
        ...
        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_openml(
            string? name = null,
            string version = "active",
            int? data_id = null,
            string? data_home = null,
            string? target_column = "default-target",
            bool cache = true,
            bool return_X_y = false,
            string as_frame = "auto",
            int n_retries = 3,
            float delay = 1.0f,
            string parser = "auto",
            PyDict? read_csv_kwargs = null) => default!;

        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) fetch_rcv1(
            string? data_home = null,
            string subset = "all",
            bool download_if_missing = true,
            int? random_state = null,
        ...
        public static sklearn.utils.Bunch fetch_species_distributions(
            string? data_home = null,
            bool download_if_missing = true,
            int n_retries = 3,
            float delay = 1.0f) => default!;

        public static string get_data_home(
            string? data_home = null) => default!;

        [VariantReturn(FirstIf = "return_X_y == false")]
        public static (sklearn.utils.Bunch? bunch, (NDarray data, NDarray target)? X_y) load_breast_cancer(
            bool return_X_y = false,
            bool as_frame = false) => default!;
