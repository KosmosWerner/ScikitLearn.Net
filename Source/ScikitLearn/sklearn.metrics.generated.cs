...
namespace ScikitLearn
{
    public static partial class sklearn
    {
        ...
        {
            metrics(NDarray y_true, NDarray y_pred, float beta = 1.0f, NDarray? labels = null, int pos_label = 1, PyObject? average = null, PyTuple? warn_for = null, NDarray? sample_weight = null, string zero_division = "warn")
            {
            }
            ...
            public class ConfusionMatrixDisplay
            {
                ...
                public PyObject im_ => Helpers.ToCSharpNDarray(self.GetAttr("im_"));
            ...
            public class PrecisionRecallDisplay
            {
                ...
                public PyObject line_ => Helpers.ToCSharpNDarray(self.GetAttr("line_"));
                public PyObject chance_level_ => Helpers.ToCSharpNDarray(self.GetAttr("chance_level_"));
                public PyObject ax_ => Helpers.ToCSharpNDarray(self.GetAttr("ax_"));
                public PyObject figure_ => Helpers.ToCSharpNDarray(self.GetAttr("figure_"));
            ...
            public class PredictionErrorDisplay
            {
                ...
                public PyObject line_ => Helpers.ToCSharpNDarray(self.GetAttr("line_"));
                public PyObject errors_lines_ => Helpers.ToCSharpNDarray(self.GetAttr("errors_lines_"));
                public PyObject scatter_ => Helpers.ToCSharpNDarray(self.GetAttr("scatter_"));
                public PyObject ax_ => Helpers.ToCSharpNDarray(self.GetAttr("ax_"));
                public PyObject figure_ => Helpers.ToCSharpNDarray(self.GetAttr("figure_"));
